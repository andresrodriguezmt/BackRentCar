...
public class ReservationController {
    ...
    public Reservation save(@RequestBody Reservation reservacion){
        return reservationService.save(reservacion);
    }
    ...
    public boolean delete(@PathVariable("id") int idReserva){
        return reservationService.delete(idReserva);
    }
    
    @GetMapping("/report-status")
    public StatusReservas getReservas(){
        return reservationService.getRepSatusRes();
    }
